            ...
            {readyToReply ?
                <>
                    ...
                    <input id='replyMessage' type='text' value={replyObj.message} onChange={(e) => replyObjSet(prevObj => {
                        ...
                        return newObj
                    })} placeholder={fromReply ? "Reply" : "Reply"} />

                    <button onClick={handleSubmit}>reply</button>
                </>
                :
                <div style={{ display: "flex", gap: ".3rem", cursor: "pointer", alignItems: "center" }} onClick={(e) => { e.stopPropagation(); readyToReplySet(true) }}>
