...
export default function NavBar({ seenUser }: { seenUser?: user }) {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "space-between", padding: ".3rem 1rem", backgroundColor: "#35A7FF", alignItems: "center", position: "relative", zIndex: "999" }}>
            <Link href={"/"}>
                ...
                {seenUser ?
                    (
                        <div style={{ position: "relative" }}>
                            ...
                            {showingMore &&
                                <div onClick={() => showingMoreSet(false)} style={{ position: "fixed", top: 0, left: 0, backgroundColor: "rgba(0,0,0,0.1)", width: "100vw", height: "100vh" }}>
                                    <ul style={{ position: "absolute", backgroundColor: "#35A7FF", width: "min(200px, 50vw)", right: "1rem", top: "3.7rem", padding: "1rem", display: "grid", gap: "1rem" }} onClick={() => showingMoreSet(false)}>
