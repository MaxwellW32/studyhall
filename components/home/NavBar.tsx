                ...
                {seenUser ?
                    (
                        <div style={{ position: "relative" }}>
                            ...
                            {showingMore &&
                                <div onClick={() => showingMoreSet(false)} style={{ position: "fixed", top: 0, left: 0, backgroundColor: "rgba(0,0,0,0.2)", width: "100vw", height: "100vh" }}>
                                    <ul style={{ position: "absolute", backgroundColor: "#333", width: "min(200px, 50vw)", right: "-1rem", top: "3rem", padding: "1rem", display: "grid", gap: "1rem" }} onClick={() => showingMoreSet(false)}>
