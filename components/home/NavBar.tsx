                    ...
                    (
                        <div style={{ position: "relative" }}>
                            <div style={{ display: "grid", gridTemplateColumns: "auto auto auto", gap: ".2rem", alignItems: "center", cursor: "pointer" }} onClick={() => showingMoreSet(prev => !prev)}>
                                <img className='profileImage' src={session.user.image ?? "https://images.pexels.com/photos/264907/pexels-photo-264907.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"} />
                            ...
                            {showingMore &&
                                <ul style={{ position: "absolute", backgroundColor: "#333", width: "20vw", right: "-1rem", padding: "1rem", display: "grid", gap: "1rem" }}>
